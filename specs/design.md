...
| `portDir` | string? | port / portN built-ins: `"in"` \| `"out"` \| `"bidir"` — **derived** from wiring (FR-094c), written at save, not hand-set (portN aggregates across its bits) |
