...
| FR-114g | §6.4, §6.11, §6.13 | `engine/memory.js` (`dumpBytes`), `sim.js` (load/stop-write), `dialogs.js`, `app.js`, `api.js`, `storage.go`, `api.go`, `cgen.js` (refusal) |
