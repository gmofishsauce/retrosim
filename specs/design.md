...
- **Satisfies:** FR-115, FR-115a, FR-115b, FR-115c, FR-115d, FR-115e (sequential), FR-115f (port binding), FR-115i (bidirectional bus columns), FR-115j (duplicate row), FR-115k (grouped hex cells); extends FR-004a (new **Simulate** menu). (FR-115g, the interim clocked-design guard, is superseded and removed.)
...
| FR-115, FR-115a–k | §6.13, §6.16, §7.7 | `engine/vectors.js`, `engine/sim.js`, `chrome/dialogs.js`, `chrome/toolbar.js`, `chrome/properties.js`, `store.js`, `app.js`, `index.html`, `style.css` |
