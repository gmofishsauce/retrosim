...
//
//   - darwin:  <home>/Documents/retrosim
//   - windows: %USERPROFILE%\Documents\retrosim (error if USERPROFILE is unset)
//   - other:   <home>/Documents/retrosim
